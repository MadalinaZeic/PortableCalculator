...
public class Numbers {
    ...
    public float diverse(float a, float b, float c) {
    ...
    public double diverse1(double a, double b, double c) {
    ...
    public int diverse2(int a, int b, int c) {
    ...
    public int diverse3(int a, int b, int c) {
        int result = a + (b / c);
        return result;
    }
    ...
    public int diverse4(int a, int b, int c, int d) {
        int result = (a + b - c) / d;
        return result;
    }
    ...
    public double diverse5(double a, double b, double c) {
        double result = (a - c) - b;
        return result;
    }
}
